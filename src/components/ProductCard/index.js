...
const ProductCard =
  ({ id, description, priceHaveDiscount, price, priceWithOutDiscount, brand, image }) => (
    <div className="ard mb-4 shadow-sm walmark-card">
      ...
      <div className="card-body">
        {priceHaveDiscount ?
          <div className="card-title pricing-card-title">
            <h3> ${price} <span className="walmark-discount">50%</span></h3>
            <h5 className="walmark-discount-price"> ${priceWithOutDiscount} </h5>
          </div>
