...
const ProductList = ({ products }) => (
  <div className="card-deck mb-3 text-center">
    {products.map(product => (
      <div key={product.id} className="ard mb-4 shadow-sm" style={{ margin: '0 0 10px 10px' }}>
        ...
        <div className="card-body">
          { product.priceHaveDiscount ?
            <div className="card-title pricing-card-title">
              ...
              <h5 style={{ textDecoration: 'line-through', color: 'grey' }}> ${product.priceWithOutDiscount} </h5>
            </div>
